...
ki = LINETCR.LINE() 
ki.login(token="En8ggCr8RVeM6MmAJOX3.JTxrVEFkWlutZXEtHUx2SW.5nD6RGWGDwN5Jv9clqhkmDLWX4KZqf5SCfgKYp3whMY=") 
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="EnxDLr8ctCzrj2BXKAae.S1K4fDyWrXn64GytVSpetG.W0++Bo/1BCcVxgTq9/CyR3YK9EAQ9Ln8+p6PQVetvks=")
kk.loginResult()

ks = LINETCR.LINE()
ks.login(token="EnS3Odh8W0Lm9b3CPoxa.0Y1NjpUBSfomeWBpI++oYG.OV1NfjKiu+T10LYpYZ1qzWGW+PHt7Z/NkOGYyKyGnoM=")
ks.loginResult()

kc = LINETCR.LINE()
kc.login(token="EnGL2YgFB2ZrEDaJBd5c.XvWV1Q6IN8PEcwaU4ObRRa.Y7M8G+aT3KzQ82MZfHxGMPfj9ba2TmlK1vxCK9fZzCY=")
kc.loginResult()

ka = LINETCR.LINE()
ka.login(token="Endii0CDUibbc0ykVWr9.qCUNJb/MXk6RiqOcToODQq.l6tOk8MhfgQWMQRM2zDeP1Cb7JgqJk8yha8X8yXDG5w=")
ka.loginResult()

print "login success"
reload(sys)
sys.setdefaultencoding('utf-8')
helpMessage =""" YOUR TEAM      
...
"""
helpMessage2 =""" COMMAND FOR BOT PROTECTED
...
wait = {
    ...
    'timeline':False,
    'autoAdd':False,
    'message':"Contact For Akun Official line.me/ti/p/~@enr7503k",
    "lang":"JP",
    "comment":"Auto like By line.me/ti/p/~ebisuindo",
    "likeOn":False,
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
...
#--------------------------------------------------------
                ...
                if wait["leaveRoom"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Leave aktif")
                    else:
                        cl.sendText(msg.to,"Already aktif")
                else:
                    wait["leaveRoom"] = True
                ...
                if wait["leaveRoom"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Leave Non-aktif")
                    else:
                ...
                if wait["timeline"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Share aktif")
                    else:
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Imposible Use Besides Æ¬he Group ")
            ...
            #---------------FUNGSI RATAIN GRUP TANPA KICK SESAMA BOT/Admin/Bots----------#
              ...
              if msg.from_ in Bots:
                if msg.toType == 2:
                    ...
                    ks.sendText(msg.to,"Salam Buat Semua Dari Saya Mr X Kaneki Team Bot")
                    msg.contentType = 13
                    msg.contentMetadata = {'mid': mid}
                    ks.sendMessage(msg)
                    targets = []
                        ...
                        for target in targets:
                          if target not in Bots:
                            try:
                                ...
                                ka.sendText(msg.to,"We Are Kaneki Team")
#-----------------------------------------------------------                          
            elif "Kick" in msg.text:
                           ...
                           pass
                            ...
                            for target in targets:
                                try:
                                    ...
                                    f=codecs.open('st2__b.json','w','utf-8')
                                    json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                    cl.sendText(msg.to,"Succes Tuan Mr x")
                                except:
                                    cl.sendText(msg.to,"Succes Tuan Mr x")
#-----------------------------------------------------------
...
#-----------------------------------------------------------
              ...
              if msg.from_ in admin:
                ...
                msg.contentMetadata = {'mid': mid}
                cl.sendMessage(msg)
                cl.sendText(msg.to,"Creator By Mr X â™›")
#-----------------------------------------------------------
                ...
                for g in gs.members:
                    if _nametarget == g.displayName:
                       ...
                       ki.sendText(g.mid,"Ini Spam âœ ")  
                       kk.sendText(g.mid,"Ini Spam âœ ")  
                       ks.sendText(g.mid,"Ini Spam âœ ")
                       kc.sendText(g.mid,"Ini Spam âœ ")
                       ka.sendText(g.mid,"Ini Spam âœ ")
                       cl.sendText(g.mid,"Ini Spam âœ ")
                       ki.sendText(g.mid,"Ini Spam âœ ")
                       kk.sendText(g.mid,"Ini Spam âœ ")
                       ks.sendText(g.mid,"Ini Spam âœ ")
                       kc.sendText(g.mid,"Ini Spam âœ ")  
...
#----------------------------------------------------------
                ...
                cl.sendText(msg.to,"GUA MR X")
                ki.sendText(msg.to,"Kaneki Hadir")
                kk.sendText(msg.to,"Uta Hadir")
                ks.sendText(msg.to,"Rize Hadir")	
                kc.sendText(msg.to,"Kishou Hadir")
                ka.sendText(msg.to,"Suzuya Hadir ")
                cl.sendText(msg.to,"Your Group Has Been Protected")
#----------------------------------------------------------
...
#-----------------------------------------------             
            ...
            try:
                if op.param3 in mid:
                    ...
                    if op.param1 in protection:
                        OWN = "uc77fd25b59f6e563d84f1334f3fed10b","u7f60bce6c583caa55b5e3f3a38897ae6","u7ac1fe74068014153e25c38a428909aa","uc25acea295673902814610eabe7fd7de","u89ef556ae594177b388c31ad783dbb23"
        ...
        if op.param1 in autocancel:
			OWN = "uc77fd25b59f6e563d84f1334f3fed10b","u7f60bce6c583caa55b5e3f3a38897ae6","u7ac1fe74068014153e25c38a428909aa","uc25acea295673902814610eabe7fd7de"
			if op.param2 in OWN:
				pass
			else:
				Inviter = op.param3.replace("",',')
